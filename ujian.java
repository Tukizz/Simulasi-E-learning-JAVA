	...
	public static void main(String[] args) {
		...
		switch (pilih) {
			case 1 :
				try{
					//cari file
					File filesoal = new File("asset/soal.txt");
					File filekunci = new File("asset/kunci.txt");
			...
			case 2 :
				...
				try{
					...
					//cari file	
					File file = new File("asset/soal.txt");
					File file2 = new File("asset/jawaban.txt");
			...
			default :
				...
				try{
					...
					//cari file
					File filejawab = new File("asset/jawaban.txt");
					File filecekkunci = new File("asset/kunci.txt");
